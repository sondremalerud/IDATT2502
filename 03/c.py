...
class ConvolutionalNeuralNetworkModel(nn.Module):
    ...
    def __init__(self):
        ...
        # 1 inn-kanal, 32 ut-kanaler, 
        self.conv1 = nn.Conv2d(1, 32, kernel_size=5, padding=2)
        self.relu = nn.ReLU()

        # Reduserer størrelsen på kanalene/bildene
        ...
        # Fjerner input som passer på at modellen ikke er for avhengig av én type input ==> sprer ut vektene
